...
#define FILENAME_WEIGHTS "../weights/InspectionDemoGoogLeNet_weights.bin"

#define ARCHNAME "GoogLeNet"
...
int main()
{
    ...
    CInspectionDemoGoogLeNet network;
    ...
    ofstream ofs("log_googlenet.csv");
    if(ifs.fail()) {
