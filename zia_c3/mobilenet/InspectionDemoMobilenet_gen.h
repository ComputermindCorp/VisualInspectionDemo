...
class CInspectionDemoMobilenet : public CDMP_Network {
 private:
  /*!
  ...
  */
  ...
  | ID | Layers | Type | Dim In | Dim Out | Param | Mem |
  | :- | :- | :-: | :-: | :-: | :-: | :-: |
  | 28 | FPGA-Layer | Convolution | (1, 1, 1024) | (1, 1, 2) | - | - |
  | 28-0 | conv_preds | Convolution | (1, 1, 1024) | (1, 1, 2) | - | 2832 |
 ...
 public:
  ...
  CInspectionDemoMobilenet();
  virtual ~CInspectionDemoMobilenet();
};
